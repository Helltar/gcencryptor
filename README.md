...
- [gcencryptor-1.5.2.tar.gz](https://github.com/Helltar/gcencryptor/releases/download/1.5.2/gcencryptor-1.5.2.tar.gz) (1.64 MB)
- [gcencryptor-1.5.2.tar.gz.sha256sum](https://helltar.com/projects/gcencryptor/bin/sha256sums/gcencryptor-1.5.2.tar.gz.sha256sum)
...
```
```
tar -xvzf gcencryptor-1.5.2.tar.gz
```
```
